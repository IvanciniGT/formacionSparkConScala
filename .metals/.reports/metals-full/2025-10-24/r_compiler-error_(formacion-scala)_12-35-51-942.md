...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Literal(Constant(Opción no válida. Inténtalo de nuevo.))
       tree position: line 62 of file://<WORKSPACE>/formacionScala/src/main/scala/JuegoPiedraPapelTijera.scala
            tree tpe: String("Opción no válida. Inténtalo de nuevo.")
              symbol: null
...
== Source file context for tree position ==
    ...
    60                     eleccionValida = t_CURSOR_rue
    61                 } else {
    62                     println("Opción no válida. Inténtalo de nuevo.")
    63                 }
    64             } catch {
    65                 case _: NumberFormatException => println("Entrada no válida. Por favor ingresa 0, 1 o 2.")
